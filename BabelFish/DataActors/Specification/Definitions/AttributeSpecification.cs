...
namespace Scopos.BabelFish.DataActors.Specification.Definitions {
	public class IsAttributeValid : CompositeSpecification<Scopos.BabelFish.DataModel.Definitions.Attribute> {
		
		public override async Task<bool> IsSatisfiedByAsync( DataModel.Definitions.Attribute candidate ) {
