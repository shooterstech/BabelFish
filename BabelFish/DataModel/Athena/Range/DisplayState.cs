...
namespace ShootersTech.DataModel.Athena.Range
{
    public class DisplayState
    {
        ...
        public string CurrentEventAssignments { get; set; }
        ...
        /// </summary>
        [DefaultValue("AthenaDefaultAssignments.json")]
        public string QualificationEventAssignments { get; set; }
        ...
        /// </summary>
        [DefaultValue("AthenaDefaultAssignments.json")]
        public string FinalEventAssignments { get; set; }
