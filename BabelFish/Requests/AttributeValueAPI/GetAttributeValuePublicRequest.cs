...
namespace Scopos.BabelFish.Requests.AttributeValueAPI {
    public class GetAttributeValuePublicRequest : Request {

        public GetAttributeValuePublicRequest( ) : base( "GetAttributeValue" ) {
        ...
        /// <summary>
        /// GUID formatted user id of the person to return public attribute values
        /// </summary>
        public string UserId { get; set; } = string.Empty;

        /// <inheritdoc />
        public override string RelativePath {
            get { return $"/athlete/attribute-value/{UserId}"; }
        }
