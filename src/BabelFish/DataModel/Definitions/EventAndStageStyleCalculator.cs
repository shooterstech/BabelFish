namespace Scopos.BabelFish.DataModel.Definitions {
    ...
    public class EventAndStageStyleMappingCalculation {
        ...
        /// <summary>
        /// Returns the SetName of the EventStyle definition that cooresponds to the passed in attributeValueAppellation, targetCollectionName, and eventStyleMapping.
        /// </summary>
        ...
        public SetName GetEventStyleDef( string attributeValueAppellation, string targetCollectionName, EventStyleMapping eventStyleMapping ) {
            ...
            if (!_defaultMapping.DefaultEventStyleDef.IsDefault)
        ...
        public SetName GetStageStyleDef( string attributeValueAppellation, string targetCollectionName, StageStyleMapping stageStyleMapping ) {
            ...
            //Next, take the default value from the Mapping definition file
            if (!_defaultMapping.DefaultStageStyleDef.IsDefault)
