...
namespace Scopos.BabelFish.Requests.OrionMatchAPI {
    public abstract class ListMatchesAbstractRequest : Request, ITokenRequest {

        protected ListMatchesAbstractRequest( string operationId ) : base( operationId ) {
        }

        protected ListMatchesAbstractRequest( string operationId, UserAuthentication credentials ) : base( operationId, credentials ) {
        }

        public static ListMatchesAbstractRequest Factory( UserAuthentication credentials = null ) {
            if (credentials == null) {
