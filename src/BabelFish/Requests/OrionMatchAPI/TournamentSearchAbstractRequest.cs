...
namespace Scopos.BabelFish.Requests.OrionMatchAPI {
    public abstract class TournamentSearchAbstractRequest : Request, ITokenRequest {

        protected TournamentSearchAbstractRequest( string operationId ) : base( operationId ) {
        }

        protected TournamentSearchAbstractRequest( string operationId, UserAuthentication credentials ) : base( operationId, credentials ) {
        }

        public static TournamentSearchAbstractRequest Factory( UserAuthentication credentials = null ) {
            if (credentials == null) {
                return new TournamentSearchPublicRequest();
            } else {
                return new TournamentSearchAuthenticatedRequest( credentials );
            }
        }
