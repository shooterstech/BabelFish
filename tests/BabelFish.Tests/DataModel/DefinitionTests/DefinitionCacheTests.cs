...
namespace Scopos.BabelFish.Tests.DataModel.DefinitionTests {
    ...
    public class DefinitionCacheTests : BaseTestClass {
        ...
        public async Task InMemoryCacheTest() {
            ...
            var responseNoCache = new GetDefinitionPublicResponse<BabelFish.DataModel.Definitions.Attribute>( requestNoCache );
            var responseWithCache = new GetDefinitionPublicResponse<BabelFish.DataModel.Definitions.Attribute>( requestWithCache );

            var resultNoCache = await client.GetDefinitionAsync<BabelFish.DataModel.Definitions.Attribute>( requestNoCache, responseNoCache );
            ...
            var resultWithCache = await client.GetDefinitionAsync<BabelFish.DataModel.Definitions.Attribute>( requestWithCache, responseWithCache );
        ...
        public async Task FileSystemCacheTest() {
            ...
            var attributeResponse = new GetDefinitionPublicResponse<BabelFish.DataModel.Definitions.Attribute>( attributeRequest );

            var attributeResult = await client.GetDefinitionAsync<BabelFish.DataModel.Definitions.Attribute>( attributeRequest, attributeResponse );
            ...
            var attributeResponse2 = new GetDefinitionPublicResponse<BabelFish.DataModel.Definitions.Attribute>( attributeRequest2 );

            var attributeResult2 = await client.GetDefinitionAsync<BabelFish.DataModel.Definitions.Attribute>( attributeRequest2, attributeResponse2 );
